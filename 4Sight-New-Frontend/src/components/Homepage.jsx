                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative group transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_30px_60px_-15px_rgba(8,89,184,0.3)]">
                        ...
                        <div className="relative bg-white p-2 sm:p-3 rounded-2xl border-2 border-[#0859b8] hover:border-[4px] transition-all duration-500 shadow-xl overflow-hidden">
                            <img src={dashboardImg} alt="Unified Marketing Dashboard" className="w-full h-auto rounded-xl object-cover group-hover:scale-[1.02] transition-transform duration-500" />
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 bodyText">
                        {[
                            ...
                            <div key={i} className="p-8 rounded-xl bg-white border border-gray-200 shadow-sm hover:shadow-md hover:border-[#00adc4] transition duration-300">
                                <h3 className="text-xl font-bold mb-3 text-[#222222] heading2">{item.title}</h3>
                                <p className="text-gray-600">{item.desc}</p>
                            </div>
                        ))}
                        <div className="p-8 rounded-xl bg-white border border-gray-200 shadow-sm hover:shadow-md hover:border-[#00adc4] transition duration-300 md:col-span-2 lg:col-span-1">
                            <h3 className="text-xl font-bold mb-3 text-[#222222] heading2">Dependence on guesswork</h3>
                            <p className="text-gray-600">Outcomes depend on trial-and-error instead of a structured system.</p>
                        </div>
                        <div className="p-8 rounded-xl bg-white border border-gray-200 shadow-sm hover:shadow-md hover:border-[#00adc4] transition duration-300 md:col-span-2 lg:col-span-2">
                            <h3 className="text-xl font-bold mb-3 text-[#222222] heading2">No unified marketing view</h3>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="lg:flex lg:justify-between lg:items-end mb-16 bodyText">
                        ...
                        <div className="mt-8 lg:mt-0">
                            <Link to="/product" className="border-2 border-[#00adc4] secondary_color font-bold py-3 px-8 rounded hover:bg-[#00adc4] hover:text-white transition">
            ...
            <section className="py-24 bg-white/60 backdrop-blur-md overflow-hidden reveal transition-all duration-700 opacity-0 translate-y-10">
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-20">
                        ...
                        <p className="text-lg text-gray-600 bodyText">Marketing 4Sight turns a structured approach into a working system. Every decision is informed by data, and every action is aligned.</p>
                    </div>
            ...
            <section className="py-24 bg-white/60 backdrop-blur-md reveal transition-all duration-700 opacity-0 translate-y-10">
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl heading1 primary_color mb-4">See Marketing 4Sight in Action</h2>
                    ...
                    <div className="flex flex-col md:flex-row justify-center items-center gap-8 lg:gap-12 relative bodyText">
                        ...
                        <div className="bg-white p-8 border border-gray-200 rounded-xl shadow-lg w-full md:w-1/3 text-center relative z-10 hover:-translate-y-1 transition duration-300">
                            <div className="w-12 h-12 primary_bg text-white rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-6">1</div>
                            <h3 className="text-xl font-bold mb-3 heading2">Set your context</h3>
                            <p className="text-gray-600 text-sm">Add your business inputs and priorities.</p>
                        </div>
                        
                        <div className="bg-white p-8 border border-gray-200 rounded-xl shadow-lg w-full md:w-1/3 text-center relative z-10 hover:-translate-y-1 transition duration-300">
                            <div className="w-12 h-12 secondary_bg text-white rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-6">2</div>
                            <h3 className="text-xl font-bold mb-3 heading2">Get structured direction</h3>
                            <p className="text-gray-600 text-sm">Get strategy, prioritized actions, and adapt based on performance and market signals.</p>
                        </div>

                        <div className="bg-white p-8 border border-gray-200 rounded-xl shadow-lg w-full md:w-1/3 text-center relative z-10 hover:-translate-y-1 transition duration-300">
                            <div className="w-12 h-12 primary_bg text-white rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-6">3</div>
                            <h3 className="text-xl font-bold mb-3 heading2">Execute & stay in control</h3>
            ...
            <section className="py-24 bg-white/40 backdrop-blur-sm border-t border-gray-200/50 reveal transition-all duration-700 opacity-0 translate-y-10">
                <div className="max-w-4xl mx-auto px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-gray-600 bodyText">Quick answers to help you understand how Marketing 4Sight works and how it fits your workflow.</p>
                    </div>

                    <div className="space-y-4">
                        {[
                            { q: "What exactly does Marketing 4Sight do?", a: "Marketing 4Sight structures your entire marketing into one connected system — it defines direction, translates it into clear actions, ensures execution is consistent, and continuously improves performance based on real outcomes. This keeps all efforts aligned, visible, and measurable in one place." },
                            { q: "How is this different from using separate tools for SEO, content, and ads?", a: "Most tools operate in silos. Marketing 4Sight connects strategy, execution, and performance across all marketing activities, ensuring decisions are aligned and outcomes are clearly visible in one place." },
                            ...
                            { q: "Can I track real business outcomes, not just marketing metrics?", a: "Yes. Marketing 4Sight focuses on meaningful outcomes — visibility, engagement, actions, and conversions — so you can understand what is actually driving results, not just surface-level metrics." },
                            { q: "Who is Marketing 4Sight best suited for?", a: "Marketing 4Sight is built for businesses managing multiple marketing activities, channels, or teams and looking for clarity in direction and execution. It aligns actions to your specific goals and context, so everything works as one connected system rather than in silos." }
                        ].map((faq, index) => (
