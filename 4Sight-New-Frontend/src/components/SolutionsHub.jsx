...
const useCasesData = {
    "strategy-planning": {
        ...
        desc: "Marketing 4Sight transforms marketing strategy from disconnected planning into a continuously guided operational system, helping teams identify priorities faster, align execution with business goals, and make sharper decisions through connected intelligence, live visibility, and data-driven direction.",
        heroImg: "Strategy overview and Action Plan dashboard interface view",
        mattersTitle: "Disconnected marketing slows decisions",
        mattersDesc: "When strategy, execution, and performance operate separately, marketing becomes harder to prioritize, adapt, and scale. Marketing 4Sight keeps planning, visibility, and operational workflows continuously connected so teams can move with greater clarity and faster decision-making.",
        compare: [
        ...
        chooseDesc: "Marketing 4Sight combines structured workflows, connected intelligence, AI-assisted systems, and data-driven decision making within one operational environment, helping businesses manage marketing with greater direction, responsiveness, and control.",
        features: [
        ...
        faqs: [
            ["How does Marketing 4Sight help with marketing strategy?", "The platform helps businesses structure marketing direction using business context, competitor intelligence, search visibility, operational goals, and market movement to create clearer priorities and connected execution planning."],
            ["Does the platform generate marketing action plans?", "Yes. Marketing 4Sight helps translate strategic direction into structured operational workflows, priorities, and implementation layers aligned to marketing goals and visibility opportunities."],
            ...
            ["How is this different from traditional marketing planning?", "Traditional planning often happens across disconnected systems and static reporting cycles. Marketing 4Sight keeps planning, implementation, governance, and optimization connected within one operational environment."],
            ["Does the platform support cross-channel planning?", "Yes. Marketing 4Sight connects planning visibility across SEO, content, local visibility, social media, campaigns, website operations, and conversion workflows."],
    ...
    governance: {
        ...
        desc: "Marketing 4Sight helps businesses monitor marketing performance, operational progress, execution consistency, and visibility movement through one connected environment, enabling teams to identify what’s working, what needs attention, and where decisions should move next with greater confidence.",
        ...
        mattersDesc: "When performance data, execution tracking, and operational visibility stay fragmented across platforms, it becomes harder to understand progress, identify priorities, and respond quickly. Marketing 4Sight keeps governance, reporting, activities, and performance visibility continuously connected so businesses operate with clearer oversight and faster decision-making.",
        compare: [
        ...
        chooseDesc: "Marketing 4Sight combines governance workflows, performance visibility, operational intelligence, and connected analytics into one structured environment, helping businesses monitor marketing with greater control, responsiveness, and decision clarity.",
        features: [
        ...
        faqs: [
            ["How does Marketing 4Sight improve marketing visibility?", "The platform connects performance tracking, execution visibility, operational workflows, and reporting into one environment so businesses can monitor marketing with greater clarity and control."],
            ["Can teams track execution progress inside the platform?", "Yes. Marketing 4Sight helps teams monitor ongoing activities, approvals, implementation status, task movement, and workflow progress across connected marketing operations."],
            ...
            ["How does governance work inside Marketing 4Sight?", "Governance combines operational monitoring, implementation visibility, activity tracking, and connected reporting so businesses maintain continuous oversight across marketing execution."],
            ["Can businesses identify performance gaps quickly?", "Yes. Marketing 4Sight continuously surfaces operational gaps, visibility changes, performance movement, and execution bottlenecks through connected intelligence and live monitoring."],
    ...
    optimization: {
        ...
        desc: "Marketing 4Sight helps businesses monitor competitive movement, visibility shifts, performance opportunities, and evolving market signals through one connected intelligence environment — enabling teams to optimize faster, respond smarter, and stay aligned with changing market dynamics.",
        ...
        mattersDesc: "Search behavior, competitors, visibility trends, and audience movement continuously evolve. Marketing 4Sight helps businesses stay connected to these changes through live intelligence, optimization visibility, and competitive monitoring so marketing direction adapts with greater speed and clarity.",
        compare: [
        ...
        chooseDesc: "Marketing 4Sight combines optimization workflows, live market visibility, competitor intelligence, AI-assisted monitoring, and connected performance insights into one operational environment, helping businesses adapt marketing direction with greater speed and confidence.",
        features: [
        ...
        faqs: [
            ["How does Marketing 4Sight support marketing optimization?", "The platform continuously surfaces visibility movement, operational changes, trend signals, and optimization opportunities so businesses can refine marketing direction faster."],
            ["Can businesses track competitors inside the platform?", "Yes. Marketing 4Sight helps monitor competitor visibility, keyword movement, content activity, and broader market positioning through connected intelligence workflows."],
            ...
            ["How does competitive intelligence work inside Marketing 4Sight?", "Marketing 4Sight combines market visibility, competitor movement, trend analysis, and operational insights into one connected intelligence environment for faster decision-making."],
            ...
            ["Is this useful for agencies and multi-brand environments?", "Yes. Marketing 4Sight helps agencies and teams maintain centralized optimization visibility and competitive intelligence across multiple brands, industries, and operational workflows."]
        ]
    },
    "multi-channel-ops": {
        badge: "Multi-Channel Ops",
        title: "Multi-channel marketing operations built for connected execution",
        desc: "Marketing 4Sight helps businesses manage websites, content, social media, campaigns, visibility, and marketing activities through one connected operational environment, enabling teams to maintain consistency, improve coordination, and execute faster across channels.",
        ...
        mattersDesc: "Websites, social media, campaigns, visibility, and content workflows continuously influence each other. Marketing 4Sight keeps operational activities connected across channels so businesses maintain stronger alignment, more consistent execution, and greater workflow visibility.",
        compare: [
        ...
        chooseDesc: "Marketing 4Sight combines operational workflows, publishing visibility, execution management, connected intelligence, and AI-assisted coordination into one environment, helping businesses maintain faster execution and stronger operational alignment across channels.",
        features: [
        ...
        faqs: [
            ["How does Marketing 4Sight support multi-channel marketing operations?", "The platform connects websites, social media, workflows, campaigns, and operational activities into one environment for more structured execution and visibility."],
            ["Can teams manage social media workflows inside the platform?", "Yes. Marketing 4Sight helps teams plan, organize, create, and monitor content across major social media platforms through connected workflows."],
            ...
            ["How does Marketing 4Sight improve operational coordination?", "The platform keeps activities, publishing schedules, workflows, and execution visibility continuously connected so teams operate with stronger alignment."],
            ["Can businesses manage content and campaigns together?", "Yes. Marketing 4Sight connects content workflows, publishing activities, campaigns, and operational visibility within one structured environment."],
    ...
    "organic-growth": {
        ...
        desc: "Marketing 4Sight helps businesses improve search visibility, local discoverability, keyword presence, and organic growth through connected SEO, GMB, content, and search intelligence workflows, enabling teams to strengthen visibility across evolving search behavior and competitive environments.",
        ...
        chooseDesc: "Marketing 4Sight combines SEO workflows, keyword intelligence, GMB visibility, optimization tracking, and connected search monitoring into one operational environment, helping businesses strengthen discoverability with greater visibility and control.",
        features: [
        ...
        faqs: [
            ["How does Marketing 4Sight improve organic visibility?", "The platform connects SEO, GMB, keyword intelligence, content workflows, and optimization visibility into one environment for stronger discoverability and search growth."],
            ["Can businesses track keyword rankings inside the platform?", "Yes. Marketing 4Sight helps monitor keyword movement, ranking visibility, search trends, and optimization opportunities continuously."],
            ...
            ["How does keyword planning work inside Marketing 4Sight?", "The platform structures keyword planning using business context, market intelligence, competitor visibility, and search intent signals connected across workflows."],
            ["Can teams monitor SEO performance continuously?", "Yes. Marketing 4Sight provides ongoing visibility into rankings, technical SEO, Core Web Vitals, optimization priorities, and discoverability movement."],
    ...
    "content-operations": {
        ...
        mattersDesc: "Content, campaigns, audience engagement, and publishing activities continuously influence brand visibility across platforms. Marketing 4Sight keeps planning, creation, and operational visibility connected so businesses maintain stronger consistency, faster execution, and clearer content direction.",
        compare: [
        ...
        chooseDesc: "Marketing 4Sight combines content workflows, publishing visibility, campaign coordination, AI-assisted execution, and connected social media operations into one environment, helping businesses maintain stronger consistency and faster content execution across platforms.",
        features: [
        ...
        faqs: [
            ["How does Marketing 4Sight support content operations?", "The platform connects content planning, workflow visibility, campaign alignment, and operational coordination into one environment for more structured execution."],
            ["Can teams manage social media workflows inside the platform?", "Yes. Marketing 4Sight helps businesses organize workflows across Instagram, Facebook, LinkedIn, X, and YouTube through connected content and operational visibility."],
            ["Can teams create social media content inside the platform?", "Yes. Marketing 4Sight helps teams create, organize, and manage social media content across platforms through connected content workflows, AI-assisted support, and centralized visibility."],
            ...
            ["How does Marketing 4Sight improve content consistency?", "The platform keeps content planning, campaigns, workflows, and operational visibility continuously connected across marketing activities and channels."],
            ["Is this useful for agencies and multi-brand teams?", "Yes. Marketing 4Sight helps agencies and teams maintain structured content workflows, operational visibility, and execution consistency across multiple brands and marketing activities."]
        ]
    }
};
                ...
                >
                    <section className="relative pt-12 pb-24 lg:pt-20 lg:pb-32 overflow-hidden flex items-center min-h-[85vh]">
                        <div className="max-w-7xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
                            ...
                            <div className="bg-white/70 backdrop-blur-2xl p-8 rounded-3xl border border-white shadow-[0_20px_60px_rgba(0,0,0,0.05)] flex items-center justify-center min-h-[400px] transform hover:scale-[1.02] transition duration-500">
                            ...
                            <div className="lg:col-span-3">
                                <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
                                    <div className="grid grid-cols-2 bg-gray-50 border-b border-gray-100 p-6">
                                        ...
                                        <div className="font-bold primary_color text-xs uppercase tracking-widest border-l border-gray-200 pl-6">Marketing 4Sight</div>
                                    </div>
                    ...
                    <section className="py-24 relative z-10">
                        <div className="max-w-7xl mx-auto px-6 lg:px-8">
                            <div className="text-center max-w-3xl mx-auto mb-20">
                                <h2 className="heading1 text-4xl primary_color mb-6">Why Businesses Choose Marketing 4Sight</h2>
