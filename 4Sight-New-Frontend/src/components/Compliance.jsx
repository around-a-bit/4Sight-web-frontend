...
const complianceData = [
    ...
    sections: [
      {
        ...
        text: "Marketing 4Sight operated by Quantyra Analytics Private Limited respects your privacy and is committed to protecting your information. This Privacy Policy explains how we collect, use, process, and safeguard data when you use the platform or website."
      },
      {
      ...
      },
      {
        ...
        text: "Where integrations are authorized, Marketing 4Sight may access limited operational data from connected services such as Google Business Profile, Google Analytics, Search Console, social media platforms, or related marketing systems."
      },
      {
      ...
      },
      {
        ...
        text: "Marketing 4Sight may use cookies and analytics technologies to improve user experience, analyze traffic, maintain sessions, and understand platform usage. For more details, please review our Cookie Policy."
      },
      {
  ...
  },
  {
    ...
    sections: [
      {
        title: "Welcome to Marketing 4Sight",
        text: "A platform developed and operated by Quantyra Analytics Private Limited (“Company”, “we”, “our”, or “us”). These Terms & Conditions govern your access to and use of the Marketing 4Sight platform, website, products, services, dashboards, workflows, and associated tools. By accessing or using the platform, you agree to comply with these Terms."
      },
      {
        title: "Eligibility",
        text: "You must be at least 18 years old and authorized to represent your business or organization to use the platform. By using Marketing 4Sight, you confirm that:",
        list: [
    ...
    sections: [
      {
        ...
        text: "This Policy applies to subscriptions and services provided through Marketing 4Sight developed and operated by Quantyra Analytics Private Limited. Marketing 4Sight is a cloud-based digital software platform delivered electronically. Access begins upon activation or onboarding."
      },
      {
  ...
  },
  {
    ...
    sections: [
      {
        title: "Introduction",
        text: "This Cookie Policy explains how Marketing 4Sight developed and operated by Quantyra Analytics Private Limited uses cookies and related technologies."
      },
      {
      ...
      },
      {
        ...
        text: "Marketing 4Sight may use cookies to:",
        gridList: [
