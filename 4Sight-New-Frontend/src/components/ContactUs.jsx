...
const ContactUs = () => {
  ...
  const autoFillMessage = (type) => {
    if (type === 'business') {
      setForm(prev => ({ ...prev, message: "Hello, I am interested in exploring Marketing 4Sight for my business. I would like to discuss demos, partnerships, or platform capabilities." }));
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
                    ...
                    <div className="pt-4 animate-[fadeInUp_0.8s_ease-out]">
                        ...
                        <p className="text-xl text-gray-600 mb-12 leading-relaxed bodyText">
                            Whether you want to explore the platform, discuss partnerships, apply for an open position, or learn more about Marketing 4Sight, our team would love to hear from you.
                        </p>
                        ...
                        <div className="bg-white/80 backdrop-blur-xl p-8 md:p-10 rounded-3xl shadow-2xl border border-gray-100 relative overflow-hidden bodyText">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5 relative z-10" noValidate>
                                ...
                                <div className="text-xs text-gray-500 text-center mt-6 pt-6 border-t border-gray-100 leading-relaxed">
                                    <p className="font-bold text-gray-700 mb-1">Marketing 4Sight is a product of Quantyra Analytics Private Limited.</p>
