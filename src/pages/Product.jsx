    ...
    return (
        <div className="text-[#222222] antialiased selection:bg-[#e7eb90] selection:text-[#222222] font-['Helvetica_Neue',sans-serif]">
            ...
            <main className="relative z-10">
                ...
                <section className="py-28 bg-gradient-to-br from-[#0859b8] via-[#0b4a94] to-[#04336b] text-white relative overflow-hidden shadow-inner">
                    {/* Decorative glows */}
                    <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#00adc4]/10 rounded-full blur-[120px] pointer-events-none transform translate-x-1/3 -translate-y-1/3"></div>
                    <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#e7eb90]/10 rounded-full blur-[120px] pointer-events-none transform -translate-x-1/3 translate-y-1/3"></div>

                    <div className="max-w-4xl mx-auto px-6 text-center relative z-10 reveal transition-all duration-700 opacity-0 translate-y-10">
                        <h2 className="text-4xl lg:text-5xl heading1 mb-8 drop-shadow-md">One Connected System.<br /> <span className="text-[#00adc4]">Built for Marketing That Works Together.</span></h2>
                        <p className="text-xl text-blue-50 mb-6 leading-relaxed bodyText font-medium">
                        ...
                        <p className="text-lg text-blue-100/90 mb-12 leading-relaxed bodyText">
                            Marketing4Sight is built to keep these moving parts connected, so marketing operates with greater alignment, continuity, and decision clarity. Instead of switching between disconnected tools, teams work within a shared system where decisions, actions, and insights remain continuously connected.
                        </p>
                        <a href="#video" className="bg-gradient-to-r from-[#00adc4] to-cyan-500 text-white font-bold py-4 px-10 rounded-full hover:shadow-[0_0_25px_rgba(0,173,196,0.6)] hover:-translate-y-1 transition-all duration-300 text-lg inline-flex items-center gap-3 group">
                            <svg className="w-6 h-6 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24"><path d="M8 5v14l11-7z" /></svg>
                            Watch How It Works
                        </a>
                    </div>
                </section>
                    ...
                    <div className="max-w-7xl mx-auto px-6 lg:px-8">
                        <div className="text-center max-w-3xl mx-auto mb-16 reveal transition-all duration-700 opacity-0 translate-y-10">
                            ...
                            <p className="text-lg text-gray-600 bodyText">
                                Each module in Marketing4Sight is designed to solve a specific operational layer while remaining connected to the broader marketing system.
                            </p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {[
                                ...
                                <div key={i} className="group bg-white/70 backdrop-blur-md p-8 rounded-xl border border-gray-200 shadow-sm hover:shadow-md hover:border-[#00adc4]/50 hover:bg-white transition-all duration-300 flex flex-col reveal opacity-0 translate-y-10" style={{ transitionDelay: `${i * 100}ms` }}>
                            ...
                            <div className="md:col-span-2 lg:col-span-3 group bg-gradient-to-br from-white/90 to-blue-50/90 backdrop-blur-md p-8 rounded-xl border border-[#00adc4]/30 shadow-sm hover:shadow-md hover:border-[#0859b8]/40 transition-all duration-300 flex flex-col md:flex-row items-center gap-8 reveal opacity-0 translate-y-10">
                                ...
                                <div>
                                    <Link to="/contact-us" className="bg-[#0859b8] text-white font-bold py-3 px-8 rounded hover:bg-[#00adc4] hover:-translate-y-1 hover:shadow-lg hover:-translate-y-2 transition-all duration-300 whitespace-nowrap block">Book a demo</Link>
                                </div>
                            </div>
                        </div>
                ...
                <section className="py-24 bg-white/95">
                    <div className="max-w-7xl mx-auto px-6 lg:px-8">
                        ...
                        <div className="space-y-16 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-1 before:bg-gradient-to-b before:from-[#00adc4] before:to-[#0859b8]">
                            ...
                            {[
                                { letter: 'S', title: 'Strategy', subtitle: 'Build direction with clarity, not assumptions.', desc: 'Marketing4Sight analyzes your business context, market landscape, competitors, and search behavior to establish a clear strategic foundation. Instead of fragmented planning, receive structured direction supported by market intelligence.', color: 'secondary_bg' },
                ...
                <section className="py-24 primary_bg text-white relative overflow-hidden">
                    ...
                    <div className="max-w-7xl mx-auto px-6 lg:px-8 reveal transition-all duration-700 opacity-0 translate-y-10">
                        <div className="text-center max-w-3xl mx-auto mb-16">
                            <h2 className="text-4xl heading1 mb-6">The Intelligence Layer Behind Marketing4Sight.</h2>
                        ...
                        <div className="grid md:grid-cols-3 gap-8 mb-12">
                            {[
                                ...
                                <div key={i} className="bg-blue-900/40 border border-blue-700/50 p-8 rounded-xl backdrop-blur-md hover:bg-blue-800/60 hover:border-[#00adc4] hover:-translate-y-2 hover:shadow-[0_10px_30px_rgba(0,173,196,0.15)] transition-all duration-300 bodyText group cursor-default">
                                    <div className="w-12 h-12 bg-blue-800 rounded-lg flex items-center justify-center mb-6 text-[#e7eb90] group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 group-hover:bg-[#00adc4] group-hover:text-white group-hover:shadow-lg">
                                    ...
                                    <h3 className="text-xl font-bold mb-3 heading2 group-hover:text-[#00adc4] transition-colors duration-300">{layer.title}</h3>
                ...
                <section className="py-24 border-b border-gray-200/50" id="video">
                    <div className="max-w-5xl mx-auto px-6 text-center reveal transition-all duration-700 opacity-0 translate-y-10">
                        <h2 className="text-4xl heading1 primary_color mb-6">See Marketing4Sight in Action.</h2>
                        ...
                        <div className="relative w-full aspect-video bg-gray-900 rounded-2xl shadow-2xl overflow-hidden mb-10 group flex items-center justify-center cursor-pointer border-4 border-white">
                            <img src={marketingDashboard || "https://via.placeholder.com/1200x675/0859b8/ffffff?text=Product+Walkthrough+Video"} alt="Marketing4Sight UI" className="absolute inset-0 w-full h-full object-cover opacity-60 group-hover:opacity-80 transition duration-500" />
                ...
                <section className="py-24 bg-white/95">
                    <div className="max-w-4xl mx-auto px-6 lg:px-8 reveal transition-all duration-700 opacity-0 translate-y-10">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-lg text-gray-600 bodyText">Quick answers to help you understand how Marketing4Sight works, adapts, and fits into different marketing workflows.</p>
                        </div>
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                { q: "Can agencies manage multiple brands?", a: "Yes. Marketing4Sight is designed to support multi-brand workflows, making it easier for agencies to manage strategy, execution, visibility, and reporting across multiple client accounts within a single environment." },
                                ...
                                { q: "Does the platform adapt based on business type?", a: "Yes. Marketing4Sight uses business context, operational inputs, market conditions, and marketing objectives to structure workflows, priorities, recommendations, and visibility differently for different business requirements." },
                ...
                <section className="bg-gradient-to-br from-[#0859b8] via-[#0b4a94] to-[#04336b] text-white py-24 text-center relative overflow-hidden">
                    {/* Subtle light overlays for premium depth */}
                    <div className="absolute top-0 right-0 w-96 h-96 bg-white/10 rounded-full blur-[100px] pointer-events-none transform translate-x-1/2 -translate-y-1/2"></div>
                    <div className="absolute bottom-0 left-0 w-96 h-96 bg-cyan-400/10 rounded-full blur-[100px] pointer-events-none transform -translate-x-1/2 translate-y-1/2"></div>

                    <div className="max-w-4xl mx-auto px-6 relative z-10 reveal transition-all duration-700 opacity-0 translate-y-10">
                        <h2 className="text-5xl lg:text-6xl heading1 mb-10 leading-tight drop-shadow-md">Bring Structure to How Your Marketing Operates.</h2>
