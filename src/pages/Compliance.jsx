    ...
    sections: [
      ...
      },
      {
        ...
        box: {
          ...
          email: "contact@quantyraanalytics.com"
        }
      }
    ]
  },
                  ...
                  {complianceData.map((item) => {
                    ...
                    return (
                      <button
                        ...
                        className={`group w-full flex items-center justify-between px-5 py-4 rounded-2xl transition-all duration-300 font-bold border ${isActive
